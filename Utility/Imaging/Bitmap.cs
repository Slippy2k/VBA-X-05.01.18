...
namespace Utility
{
    ...
    internal class Bitmap
    {
        ...
        internal async Task SaveAsync(IOutputStream fs)
        {
            //BinaryWriter writer = new BinaryWriter(fs);
            using (DataWriter writer = new DataWriter(fs))
            {
                writer.WriteByte((byte)0x42);
                writer.WriteByte((byte)0x4d);

                // File header
                writer.WriteInt32(this.fileHeader.SizeInBytes);
                writer.WriteInt16(this.fileHeader.Reserved1);
                writer.WriteInt16(this.fileHeader.Reserved2);
                writer.WriteInt32(this.fileHeader.PixelArrayOffset);

                // V4 Header
                writer.WriteInt32(this.v4header.HeaderSize);
                writer.WriteInt32(this.v4header.PixelWidth);
                writer.WriteInt32(this.v4header.PixelHeight);
                writer.WriteInt16(this.v4header.ColorPlanes);
                writer.WriteInt16(this.v4header.BPP);
                writer.WriteInt32(this.v4header.Compression);
                writer.WriteInt32(this.v4header.ImageSize);
                writer.WriteInt32(this.v4header.PPMWidth);
                writer.WriteInt32(this.v4header.PPMHeight);
                writer.WriteInt32(this.v4header.ColorsInPalette);
                writer.WriteInt32(this.v4header.UsedPaletteColors);
                writer.WriteUInt32(this.v4header.RedMask);
                writer.WriteUInt32(this.v4header.GreenMask);
                writer.WriteUInt32(this.v4header.BlueMask);
                writer.WriteUInt32(this.v4header.AlphaMask);
                writer.WriteInt32(this.v4header.CSType);
                for (int i = 0; i < 36; i++)
                {
                    writer.WriteByte(this.v4header.Endpoints[i]);
                }
                writer.WriteInt32(this.v4header.GammaRed);
                writer.WriteInt32(this.v4header.GammaGreen);
                writer.WriteInt32(this.v4header.GammaBlue);

                // Pixels
                for (int i = 0; i < this.pixels.Length; i++)
                {
                    writer.WriteByte(pixels[i]);
                }
